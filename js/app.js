...
*/
    ...
    function getTargetElements(target) {
        ...
        return dist_toArray(elements).reduce((function(result, element) {
            return [].concat(_toConsumableArray(result), _toConsumableArray(dist_toArray(element).filter(isNode)));
        }), []);
    }
    ...
    function createElement(name, attributes) {
        ...
        Object.keys(attributes).forEach((function(attribute) {
            ...
            if (attribute === "children") element.append.apply(element, _toConsumableArray(dist_toArray(value))); else element.setAttribute(attribute, value);
        }));
        return element;
    }
    var defaults = {
    ...
    function unSplitWords(element) {
        if (!get(element).isWord) dist_toArray(element.children).forEach((function(child) {
    ...
    var dist_defaults = extend(defaults, {});
    var SplitType = function() {
        dist_createClass(SplitType, null, [ {
            ...
            value: function setDefaults(options) {
                dist_defaults = extend(dist_defaults, parseSettings(options));
                return defaults;
            }
        }, {
            key: "revert",
        ...
        function SplitType(elements, options) {
            ...
            this.isSplit = false;
            this.settings = extend(dist_defaults, parseSettings(options));
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const textElements = document.querySelectorAll(".hero__text p, .subtitle, .text p");
        ...
        textElements.forEach(((textElement, index) => {
            gsapWithCSS.fromTo(textElement.querySelectorAll(".word"), {
                opacity: 0,
                y: 10
            }, {
                opacity: 1,
